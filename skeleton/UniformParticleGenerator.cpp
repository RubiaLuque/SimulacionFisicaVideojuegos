...
template<typename T>
UniformParticleGenerator<T>::UniformParticleGenerator(Vector3 meanPos, Vector3 meanVel, Vector3 posWidth, Vector3 velWidth, Data::GENERATORS g, PxPhysics* gPhysics, PxScene* gScene)
{
